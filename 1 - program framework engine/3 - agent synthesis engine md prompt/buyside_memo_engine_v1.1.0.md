...
**Version:** v1.1.0
**Generated:** 2026-01-16T18:30:00
**Run ID:** hood-iteration-learnings
...
#### 1. Decision Framework Updates
- **NEW:** Forced Bucket Classification — position recommendations must classify into exactly one bucket (1-4)
- **NEW:** Pass Memo Requirements — passes must include action price + information triggers
- **NEW:** "Where Would You Act?" required for all memos
- **UPDATED:** Decision Readiness rubric penalizes "watchlist" without action criteria

#### 2. Evidence Quality Updates
- **NEW:** Source Classification framework (Facts / Opinions / Primary Sources)
- **NEW:** Origin Tracing Rule — trace secondary sources back to primary origin
- **UPDATED:** Phase 1 research requires citing source types for target AND competitors
- **UPDATED:** Evidence Quality caps at 6 if no primary sources cited

#### 3. Valuation Updates
- **NEW:** Entry Price Derivation requirement (derive from valuation, not anchor to current price)
- **UPDATED:** Probability Grounding requirement (cite evidence or use qualitative)
- **UPDATED:** Valuation Rigor rubric rewards grounded probabilities and derived entry prices

#### 4. Catalyst/Kill Condition Updates
- **UPDATED:** Milestone-based triggers replace calendar-based deadlines
- **UPDATED:** Kill conditions require observable verification sources
- **UPDATED:** All bucket templates now include milestone-based kill condition guidance

#### 5. Writing Playbook Updates
- **NEW:** Phase 5 Pre-Submission Checklist (6 self-test questions)
- **UPDATED:** Phase 1 includes source classification with competitor research
- **UPDATED:** Phase 2 includes entry price derivation and probability grounding

#### 6. Anti-Pattern Updates
- **NEW:** Ungrounded Probability Theater anti-pattern added to Section F
...
### Headers/Footers
- Header: "Buyside Memo Engine v1.1.0"
...
*End of v1.1.0 Instruction Manual*

**Changes from v1.0.0:** Decision framework (forced bucket classification, pass requirements), source classification, entry price derivation, milestone-based triggers, probability grounding, pre-submission checklist.
